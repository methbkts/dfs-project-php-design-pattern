                    ...
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                                ...
                                <p class="text-white-50"> pour voir plus de produits propose par <?= $value->farmer ?> <button type="button" <?php 
                                         foreach($farmers as $key => $value){ 
                                            $farmer_id = $value->id;
                                         ?> value="<?= $farmer_id ?>" <?php }?>
                                           class="btn btn-info"><i class="fas fa-binoculars"></i></button> 
                                           <button type="button" value="<?= $value->id ?>" class="btn btn-warning"><i class="far fa-edit"></i></button> 
                                           <button type="button" value="<?= $value->id ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></button> </p>
